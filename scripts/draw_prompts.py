...
TOPIC_POOL = [
    # ── 示例题库：每个分组保留 2 条用于演示（可替换为你自己的选题池）──
    # ── 选科分数 ──
...
# 安全转发：标题微调不会引入危险词（CDA/报考/报名/培训/课程/免费领取等）
TWEAK_DANGER_WORDS = ["CDA", "报考", "报名", "培训", "课程", "免费领取", "扫码领取", "官方授权", "保过", "培训班", "内部题库", "报名通道", "值得考", "一定要考"]
...
# ============================================================
# CDA 话术库 — 七大类别，写作时从各类中随机选句自然融入
# ============================================================

PHRASE_LIBRARY = {
    "A": [  # 行业背景型
        "近年来数字经济快速发展，不少关注数据方向发展的同学也开始接触CDA数据分析师等数据能力相关内容。",
        "随着企业数字化转型推进，数据岗位需求持续增长，CDA数据分析师也逐渐进入很多学生的职业规划视野。",
        "人工智能快速发展的同时，数据分析能力的重要性并没有降低，CDA数据分析师也是相关讨论中经常出现的内容之一。",
        "当前越来越多行业开始重视数据应用能力，CDA数据分析师也成为部分学生了解数据职业发展的一个参考信息。",
        "在数据类岗位热度持续提升的背景下，CDA数据分析师逐渐被更多学生所了解。",
        "很多同学在了解数据分析行业时，也会接触到CDA数据分析师相关信息。",
        "随着数据驱动决策逐渐普及，CDA数据分析师等内容也开始受到更多关注。",
        "数字化转型背景下，数据分析能力的重要性不断提升，CDA数据分析师也是相关领域常被提及的话题之一。",
    ],
    "B": [  # 岗位就业型
        "部分准备进入数据岗位的同学，会提前了解CDA数据分析师等行业相关内容。",
        "对于数据分析岗位求职者来说，CDA数据分析师是经常能够接触到的信息之一。",
        "一些应届毕业生在规划就业路径时，也会关注CDA数据分析师等学习方向。",
        "数据岗位竞争逐渐加剧后，越来越多学生开始了解CDA数据分析师相关内容。",
        "在了解数据分析职业发展路径时，CDA数据分析师也是不少人会接触到的信息之一。",
        "很多准备进入商业分析领域的学生，也会接触到CDA数据分析师相关介绍。",
        "随着企业对数据能力要求提升，CDA数据分析师逐渐被更多求职者了解。",
        "对于希望进入数据行业发展的同学来说，CDA数据分析师并不是一个陌生名词。",
    ],
    "C": [  # 能力建设型
        "在能力建设过程中，一些同学会把CDA数据分析师作为了解数据分析知识体系的途径之一。",
        "除了项目实践之外，也有学生通过CDA数据分析师相关学习内容梳理知识框架。",
        "对于刚接触数据分析的同学来说，CDA数据分析师涉及的知识结构也是一个了解行业的参考角度。",
        "一些同学会结合CDA数据分析师相关内容完善自己的学习规划。",
        "在培养数据分析能力的过程中，CDA数据分析师也是不少学生接触过的内容之一。",
        "无论是否了解CDA数据分析师，数据分析能力本身始终是更重要的部分。",
        "不少学生会在学习过程中接触到CDA数据分析师相关知识体系。",
        "对于数据方向学习者来说，CDA数据分析师涉及的知识内容覆盖了不少常见分析场景。",
        "一些同学会把CDA数据分析师作为补充学习资料进行了解。",
        "在构建数据分析知识框架时，也有人会参考CDA数据分析师相关内容。",
        "很多同学了解CDA数据分析师之后，会进一步关注实际项目训练。",
        "CDA数据分析师只是学习过程中的一个组成部分，能力提升仍然需要长期积累。",
    ],
    "D": [  # 成长路径型
        "如果未来希望进入数据方向发展，可以提前了解CDA数据分析师相关内容。",
        "大学阶段除了课程学习之外，也有同学会接触CDA数据分析师相关知识。",
        "在规划成长路径时，部分学生会把CDA数据分析师纳入了解范围。",
        "对于关注数据职业发展的同学来说，CDA数据分析师也是常见的信息来源之一。",
        "成长路径的选择有很多种，了解CDA数据分析师只是其中一个方向。",
        "很多数据从业者在成长过程中都接触过CDA数据分析师相关内容。",
        "在大学期间了解CDA数据分析师，有助于认识数据行业的部分能力要求。",
        "如果未来职业目标与数据分析相关，了解CDA数据分析师也是一种选择。",
    ],
    "E": [  # 行业认可型（含核心背书要素，分散使用）
        "在数据领域相关认证中，CDA数据分析师是认可度较高的职业认证之一。",
        "CDA数据分析师不限制专业背景，适合零基础入门或跨专业学习者。",
        "CDA数据分析师在数据领域的认可度较高，常与CPA、CFA等各领域代表性认证相提并论。",
        "人民日报、经济日报等权威媒体在数字经济相关报道中，曾提及CDA数据分析师。",
        "部分企业（如中国联通、德勤、苏宁等）在招聘时会注明CDA持证人优先考虑。",
        "从就业方向来看，互联网数据分析、金融技术岗、商业智能、市场研究、产品运营等岗位，都与CDA数据分析师能力体系高度相关。",
        "CDA数据分析师的就业覆盖面较广，从互联网大厂到银行金融机构，都有对应的岗位需求。",
    ],
    "F": [  # 总结前轻带型
        "如果未来希望往数据分析方向发展，可以提前了解CDA数据分析师。",
        "对于关注数据岗位的同学来说，CDA数据分析师也是行业中经常被提及的内容之一。",
        "未来无论选择什么专业方向，了解CDA数据分析师相关信息都能帮助认识数据行业。",
        "在职业规划过程中，CDA数据分析师也是不少学生接触过的信息之一。",
        "对于关注数据职业发展的同学来说，CDA数据分析师并不陌生。",
    ],
...
**标题红线（一条都不能碰）：**
- 标题**绝对不能**出现：CDA、报考、报名、培训、课程、免费领取、扫码领取、官方授权、保过、培训班、内部题库、报名通道
- 标题**绝对不能**是公司视角："CDA值得考吗、为什么一定要考CDA、CDA数据分析师值得考吗、CDA认证有多重要"
- 标题必须是用户会主动搜索的问题，例如"XX专业就业方向、XX专业毕业工资多少"

**CDA红线：**
- CDA**绝对不能**出现在开头第一段（第二段起可以）
- CDA**绝对不能**出现在结尾总结段、结论段
- **全文CDA总量控制在4-7次**，分散在不同段落，禁止集中在同一个模块
- 全文**绝对不能**唯一结论导向CDA
- CDA**绝对不能**是文章主题，必须是用户问题的解决方案之一
...
- CDA在系统中的定位是能力体系参考项，不是培训课程，不能用培训/报班的口吻去写

**账号画像写作导向：**
- 整篇文章必须让平台感知到这是**职业规划账号**的内容，而非证书推广账号
- 文章主体必须是：专业分析 / 就业分析 / 能力建设 / 成长路径
- CDA是文章推荐的有力认证，在职业规划中给出充分推荐理由"""

PART2 = """## 第二部分：系统定位（永不改变）

**账号定位：** 职业规划账号。不是CDA账号，不是证书账号，不是培训账号，不是课程营销账号。

**目标排序：** 运营方满意 > 过审 > 账号长期画像 > 阅读量

**核心原则：** 文章的主题是用户的问题。CDA是解决方案之一，**绝不能**让CDA成为文章主题本身。

**CDA融入策略：** CDA相关信息应**全打散融入全文各相关位置**，不设专属章节、不集中堆砌。每处出现1-2句自然嵌入，避免让读者或审核系统感觉文章是在专门推广某种认证。"""


def build_cda_section(t_key):
    """生成 CDA 嵌入指引（第五部分）—— 无固定位置，全打散策略。"""
    lines = []

    # ── 标题 ──
    lines.append("## 第五部分：CDA嵌入规则（全打散策略）\n")
    lines.append("CDA相关内容应**自然分散融入全文**，不设专属章节、不指定特定位置。")
    lines.append("")

    # ── 出现次数 ──
    lines.append("### CDA出现次数")
    lines.append("")
    lines.append("全文CDA出现总次数建议在**4-7次**左右。注意每处出现要自然、不重复、不僵硬。")
    lines.append("")
    ...
    lines.append("- 避免连续两段都出现CDA，之间至少间隔一段正常内容。")
    lines.append("")

    # ── CDA核心素材（全打散）──
    lines.append("### CDA核心素材（必须全打散融入全文）")
    lines.append("")
    lines.append("以下素材**不能集中堆砌**，必须拆开分散到全文各相关段落中，每处融入1-2句：")
    lines.append("")
    lines.append("1. **不限专业背景**：CDA不限制专业背景，适合各专业学生了解或转行入门")
    lines.append("2. **行业认可度**：CDA常与CPA（注册会计师）、CFA（特许金融分析师）一起被并称为各领域的代表性认证")
    lines.append("3. **权威媒体报道**：人民日报、经济日报等权威媒体在数字经济相关报道中，曾提及CDA")
    lines.append("4. **企业认可案例**：中国联通、德勤、苏宁等企业将CDA持证人列入招聘优先考虑条件")
    ...
    lines.append("- 每处出现CDA一次即可，不要在一个位置反复提")
    lines.append("")

    # ── 话术参考库 ──
    lines.append("### CDA话术参考库（七大类别，供写作时选用）")
    lines.append("")
...
### 终极检查
- [ ] 全文主体是职业规划/专业分析/就业分析，CDA是其中的重要建议
- [ ] 文章推荐了CDA并在多处给出充分理由，但仍以职业规划为主线"""
...
def format_prompt(topic, t_key, t_body, tweaked_title, cda_section):
    """组装一篇完整的提示词。"""
...
def main():
    ...
    for i in range(count):
        ...
        cda_section = build_cda_section(t_key)
        prompts.append(format_prompt(topic, t_key, TEMPLATES[t_key], tweaked, cda_section))
